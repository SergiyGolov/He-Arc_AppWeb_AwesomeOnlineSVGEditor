    ...
    <div id="editor" class="expand">
      ...
      <div id="options">
        ...
        <div class="height-null">
          ...
          <div id="forward">
            <div class="aspect-ratio">
              <button id="moveForward" class="btn btn-outline-warning btn-sm">Move<br/>forward</buttton>
            </div>
          </div>
          <div id="backward">
            <div class="aspect-ratio">
              <button id="moveBackward" class="btn btn-outline-warning btn-sm">Move<br/>backward</buttton>
            </div>
          </div>
          <div>
          </div>
